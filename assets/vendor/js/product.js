                                ...
                                '<span class="remove size-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            ...
                                            '</label>'+
                                            '<input type="text" name="size[]" class="input-field" placeholder="'+lang.lang649+'">'+
                                        '</div>'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            '<label>'+
                                            'Size Qty :'+
                                            ...
                                            '</label>'+
                                            '<input type="number" name="size_qty[]" class="input-field" placeholder="'+lang.lang651+'" value="1" min="1">'+
                                        '</div>'+
                                        '<div class="col-md-4 col-sm-6">'+
                                            '<label>'+
                                            'Size Price :'+
                                            ...
                                            '</label>'+
                                            '<input type="number" name="size_price[]" class="input-field" placeholder="'+lang.lang653+'" value="0" min="0">'+
                                        '</div>'+
                                    '</div>'+
                                '</div>'
                            +'');
    ...
    $("#feature-section").append(''+
                            '<div class="feature-area">'+
                                '<span class="remove feature-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-lg-6">'+
                                            '<input type="text" name="features[]" class="input-field" placeholder="'+lang.lang687+'">'+
                                        '</div>'+
                                        '<div class="col-lg-6">'+
                                            '<div class="input-group colorpicker-component cp">'+
    ...
    $("#license-section").append(''+
                            '<div class="license-area">'+
                                '<span class="remove license-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-lg-6">'+
                                            '<input type="text" name="license[]" class="input-field" placeholder="'+lang.lang698+'" required="">'+
                                        '</div>'+
                                        '<div class="col-lg-6">'+
                                            '<input type="number" name="license_qty[]" min="1" class="input-field" placeholder="'+lang.lang699+'" value="1">'+
                                        '</div>'+
                                    '</div>'+
                            '</div>'
                            +'');
    ...
    $("#whole-section").append(''+
                            '<div class="feature-area">'+
                                '<span class="remove whole-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-lg-6">'+
                                            '<input type="number" name="whole_sell_qty[]" class="input-field" placeholder="'+lang.lang661+'" min="0" required>'+
                                        '</div>'+
                                        '<div class="col-lg-6">'+
                                            '<input type="number" name="whole_sell_discount[]" class="input-field" placeholder="'+lang.lang662+'" min="0" required>'+
                                        '</div>'+
                                    '</div>'+
                            '</div>'
                            +'');        
    ...
    $("#whole-section").append(''+
                            '<div class="feature-area">'+
                                '<span class="remove whole-remove"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        '<div class="col-lg-6">'+
                                            '<input type="number" name="whole_sell_qty[]" class="input-field" placeholder="'+lang.lang661+'" min="0">'+
                                        '</div>'+
                                        '<div class="col-lg-6">'+
                                            '<input type="number" name="whole_sell_discount[]" class="input-field" placeholder="'+lang.lang662+'" min="0">'+
                                        '</div>'+
                                    '</div>'+
                            '</div>'
                            +'');
